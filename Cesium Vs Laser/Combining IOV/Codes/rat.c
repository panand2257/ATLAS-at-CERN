...
TH1F* A = new TH1F("(Extended Barrel) Channel A", "IOV3",50,-2.,2.);
TH1F* B = new TH1F("(Extended Barrel) Channel BC", "IOV3",50,-2.,2.);
TH1F* D = new TH1F("(Extended Barrel) Channel D", "IOV3",50,-2.,2.);
