          ...
          while(std::getline(f_Masked,line))
            {
             ...
             double drift1= (tmp_constant)*100.;
           ...
           while(std::getline(f_Masked,line))
            {
             ...
             double drift2= (tmp_constant)*100.;
             
           Las_constant[myPart_ctr][tmp_module-1][tmp_channel] = a/drift2 ;
                  }
        }
     f_Masked.clear();
     f_Masked.seekg(0, ios::beg);
          ...
          while(std::getline(f_Masked,line))
            {
             ...
             double drift3= (tmp_constant)*100.;
          ...
          while(std::getline(f_Masked,line))
            {
             ...
             double drift4= (tmp_constant)*100.;
           Cesium_constant[myPart_ctr][tmp_module-1][tmp_channel] = c/drift4;
...
TH1F* A = new TH1F("(Extended Barrel) Channel A", "IOV3",50,0.97,1.02);
TH1F* B = new TH1F("(Extended Barrel) Channel BC", "IOV3",50,0.97,1.02);
TH1F* D = new TH1F("(Extended Barrel) Channel D", "IOV3",50,0.97,1.02);
...
A->GetXaxis()->SetTitle("f_{Laser}/f_{Cesium}");
A->GetYaxis()->SetTitle("Channels/bin");
A->SetLineColor(kRed);



B->GetXaxis()->SetTitle("f_{Laser}/f_{Cesium} ");
B->GetYaxis()->SetTitle("Channels/bin");
B->SetLineColor(kBlue);




D->GetXaxis()->SetTitle("f_{Laser}/f_{Cesium} ");
D->GetYaxis()->SetTitle("Channels/bin");
