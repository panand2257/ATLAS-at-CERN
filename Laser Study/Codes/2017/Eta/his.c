...
f_Masked.open("masked_channels_341673.txt");
    ...
    // Fill histoAms
       ...
       TH1F* A =   new TH1F("A", "Channel A",50,-15.,25.);
        

          TH1F* B=   new TH1F("BC", "Channel BC",50,-15.,26.);
        
         TH1F* D =   new TH1F("D", "Channel D",50,-25.,25.);
...
B ->Draw();
//B->SetTitle(";Drift (%) [Run 314511]");          //start
//B->SetTitle(";Drift (%) [Run 325677]");          //middle
B->SetTitle(";Drift (%) [Run 341673]");          //end
