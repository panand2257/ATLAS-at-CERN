...
TH1F* A1 = new TH1F("BC7", "Channel BC_{7}",50,-0.3,0.3);
...
{    //-------- read the data
   ...
   ifstream f_Masked;
    ...
    for(int m = 1; m < 65; m++)
    {
           ...
           //A1 -> Fill(Las_constant[1][m-1][33]-Las_constant[1][m-1][34]);
           A1 -> Fill(Las_constant[1][m-1][41]-Las_constant[1][m-1][44]);
...
A1-> GetXaxis() -> SetTitle("PMT gain difference");    
