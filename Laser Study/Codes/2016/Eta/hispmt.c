...
D ->Draw();
//D->SetTitle(";#DeltaPMT [Run 288060];Number of Entries");          //start
D->SetTitle(";#DeltaPMT [Run 300585];Number of Entries");          //middle
//D->SetTitle(";#DeltaPMT [Run 313662];Number of Entries");          //end
