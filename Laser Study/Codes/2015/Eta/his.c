...
f_Laser.open("LaserCombined_280965.txt");               //rms check
f_Masked.open("masked_channels_280965.txt");
    ...
    // Fill histoAms
       ...
       TH1F* A =   new TH1F("A", "Channel A",50,-50.,-5.);
        

          TH1F* B=   new TH1F("BC", "Channel BC",50,-50.,-5.);
        
         TH1F* D =   new TH1F("D", "Channel D",50,-50.,-5.);
...
B ->Draw();
//B->SetTitle(";Drift (%) [Run 265497];Number of Entries");         //start
//B->SetTitle(";Drift (%) [Run 277650];Number of Entries");         //middle
//B->SetTitle(";Drift (%) [Run 287886];Number of Entries");         //end
B->SetTitle(";Drift (%) [Run 280965];Channels/bin");         //rms check
