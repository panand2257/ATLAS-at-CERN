...
//f_Masked.open("masked_channels_287886.txt");
    ...
    // Fill histoAms
       ...
       TH1F* A =   new TH1F("A", "Channel A",50,-5.,5.);
          ...
          TH1F* B=   new TH1F("BC", "Channel BC",50,-5.,5.);
        
         TH1F* D =   new TH1F("D", "Channel D",50,-5.,5.);
...
D ->Draw();
//B->SetTitle(";#DeltaPMT [Run 265497];Number of Entries");         //start
//B->SetTitle(";#DeltaPMT [Run 277650];Number of Entries");         //middle
//D->SetTitle(";#DeltaPMT [Run 287886];Number of Entries");         //end
